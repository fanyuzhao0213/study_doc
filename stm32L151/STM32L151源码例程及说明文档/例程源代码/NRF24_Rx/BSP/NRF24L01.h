...
#define _BSP_NRF24_CE_LOW   	HAL_GPIO_WritePin(CE_GPIO_Port, CE_Pin, GPIO_PIN_RESET) //24L01使能信号
#define _BSP_NRF24_CE_HIGH   	HAL_GPIO_WritePin(CE_GPIO_Port, CE_Pin, GPIO_PIN_SET)

#define _BSP_NRF24_CSN_LOW 		HAL_GPIO_WritePin(CSN_GPIO_Port, CSN_Pin, GPIO_PIN_RESET) //SPI片选信号
#define _BSP_NRF24_CSN_HIGH		HAL_GPIO_WritePin(CSN_GPIO_Port, CSN_Pin, GPIO_PIN_SET)

#define _BSP_NRF24_IRQ_READ		HAL_GPIO_ReadPin(IRQ_GPIO_Port, IRQ_Pin)  //IRQ主机数据输入
